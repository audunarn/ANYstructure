...
obj_dict = {'mat_yield': [355e6, 'Pa'], 'mat_factor': [1.15, ''],'span': [4, 'm'], 'spacing': [0.75, 'm'],
            'plate_thk': [0.015, 'm'],
...
obj_dict_cyl_ring2 = {'mat_yield': [355e6, 'Pa'], 'mat_factor': [1.15, ''],'span': [5, 'm'], 'spacing': [0.6, 'm'],
                    'plate_thk': [0.015, 'm'],
                    'stf_web_height': [0.480, 'm'], 'stf_web_thk': [0.01, 'm'], 'stf_flange_width': [0.15, 'm'],
                    'stf_flange_thk': [0.02, 'm'], 'structure_type': ['BOTTOM', ''], 'plate_kpp': [1, ''],
                    'stf_kps': [1, ''], 'stf_km1': [12, ''], 'stf_km2': [24, ''], 'stf_km3': [12, ''],
                    'sigma_y1': [80, 'MPa'], 'sigma_y2': [80, 'MPa'], 'sigma_x2': [80, 'MPa'], 'sigma_x1': [80, 'MPa'], 'tau_xy': [5, 'MPa'],
                    'stf_type': ['T', ''], 'structure_types': [structure_types, ''], 'zstar_optimization': [True, ''],
...
obj_dict_L = {'mat_yield': [355e6, 'Pa'], 'mat_factor': [1.15, ''], 'span': [2, 'm'], 'spacing': [0.6, 'm'],
            'plate_thk': [0.010, 'm'],
...
shell_dict = {'plate_thk': [20 / 1000, 'm'],
              'radius': [5500 / 1000, 'm'],
              'distance between rings, l': [4000 / 1000, 'm'],
              'length of shell, L': [20000 / 1000, 'm'],
              'tot cyl length, Lc': [20000 / 1000, 'm'],
...
shell_main_dict2 = {'sasd': [-14.84 * 1e6, 'Pa'],
             'smsd': [-140.68* 1e6, 'Pa'],
             'tTsd': [0* 1e6, 'Pa'],
             'tQsd': [9.84* 1e6, 'Pa'],
             'psd': [-0.1* 1e6, 'Pa'],
